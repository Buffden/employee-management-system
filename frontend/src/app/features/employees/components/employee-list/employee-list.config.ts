...
export const employeeListConfig: TableConfig = {
    ...
    columns: [
        { key: 'name', header: 'Name', sortable: true, type: ColumnType.LINK, isSticky: true, navigationTarget: 'employee', navigationIdKey: 'id' },
        ...
        { key: 'departmentName', header: 'Department', sortable: true, type: ColumnType.LINK, navigationTarget: 'department', navigationIdKey: 'departmentId' },
        { key: 'locationName', header: 'Location', sortable: true, type: ColumnType.LINK, navigationTarget: 'location', navigationIdKey: 'locationId' },
        { key: 'managerName', header: 'Manager', sortable: true, type: ColumnType.LINK, navigationTarget: 'employee', navigationIdKey: 'managerId' },
